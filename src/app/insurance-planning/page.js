...
export const metadata = {
    title: 'Trilogy | Insurance-Planning',
    ...
    return (
        <>
            ...
            <main className='flex flex-col items-center w-full'>
                 <section id='hero5' className='flex flex-col items-center justify-center p-4'>
                     <h1 className='mb-4 text-4xl font-semibold text-center text-slate-500'>INSURANCE SERVICES</h1>
                     <div className='bg-white p-6 max-w-[1200px]' >
                        <h2 className='mb-3 text-3xl font-semibold text-center '>A Team Dedicated To Helping You Navigate Insurance</h2>
                        <p className='text-[#007d8a] text-xl text-center mb-3 font-semibold'>We’re building foundations and protecting futures.</p>
                        <p className='text-xl text-center '>You build wealth not to be wealthy — you earn it, invest it and grow it — to live the life you dream. Our Financial Advisors are here to help with all your insurance needs.</p>
                     </div>
                 </section>

                 <section className='grid grid-cols-1 md:grid-cols-2 md:gap-x-6 p-4 max-w-[1200px]'>
                    <div className=''>
                        <h3 className='mb-3 text-3xl font-semibold md:text-4xl'>Our Insurance Services:</h3>
                        ...
                        <ul className='grid grid-cols-2 mb-4 gap-y-4 md:text-xl'>
                    ...
                    <div className='bg-[#007d8a] px-5 py-10'>
                        <h3 className='mb-4 text-3xl font-semibold text-white md:text-4xl' >At Trilogy, we empower you to feel confident and protected in your foundation.</h3>
                 ...
                 <section className='bg-[#efefef] px-6 py-10 w-full flex flex-col items-center'>
                    <h3 className='mb-2 text-3xl font-bold text-center md:text-4xl'>Insuring Against Future Risks is Highly Personal</h3>
                    ...
                    <ul className='flex items-center flex-col lg:flex-row gap-4 max-w-[1200px]'>
                        <li className='flex flex-col items-center text-center gap-y-4 md:text-xl'><TbMessageCircleDollar className='text-7xl text-[#007d8a] transition-all duration-300 ease-in-out hover:scale-125' />Discuss options with your Advisor and family</li>
                        <li className='flex flex-col items-center text-center gap-y-4 md:text-xl'><FaHome className='text-7xl text-[#007d8a] transition-all duration-300 ease-in-out hover:scale-125' />Consider the life you’ve built and want to maintain</li>
                        <li className='flex flex-col items-center text-center gap-y-4 md:text-xl'><FaExclamationTriangle className='text-7xl text-[#007d8a] transition-all duration-300 ease-in-out hover:scale-125' />Manage your risk</li>
                        <li className='flex flex-col items-center text-center gap-y-4 md:text-xl'><FaHands className='text-7xl text-[#007d8a] transition-all duration-300 ease-in-out hover:scale-125' />Take a holistic approach</li>
                    </ul>
                    
                 </section>

                 <section id='hero6'className='flex-col justify-center hidden p-4 md:flex' >
                    <div className='bg-[rgba(255,255,255,0.8)] flex flex-col justify-center p-6 items-center w-[500px]'>
                        <h3 className='mb-4 text-3xl font-semibold text-center md:text-4xl'>Insurance Products for Your Unique Needs</h3>
                 ...
                 <section className='bg-[#efefef] px-6 py-10 w-full flex flex-col items-center'>
                    <h4 className='mb-5 text-3xl font-bold text-center md:text-4xl'>Building Foundations and Futures</h4>
                        ...
                        <ul className='grid grid-cols-1 lg:grid md:grid-cols-2 lg:grid-cols-4 gap-4 max-w-[1200px]'>
                            <li className='flex flex-col items-center text-center gap-y-1 md:text-xl'>
                                <IoSyncCircleSharp className='text-7xl text-[#007d8a] transition-all duration-300 ease-in-out hover:scale-125 mb-2' />
                                <h4 className='text-2xl font-bold'>Your Insurance Should Strategically Align With Your Financial Plan.</h4>
                            ...
                            <li className='flex flex-col items-center text-center gap-y-1 md:text-xl'>
                                ...
                                <h4 className='text-2xl font-bold'>We Offer Insurance Products For Your Unique Needs.</h4>
                            ...
                            <li className='flex flex-col items-center text-center gap-y-1 md:text-xl'>
                                ...
                                <h4 className='text-2xl font-bold'>Insuring Against Future Risks Is Highly Personal.</h4>
                            ...
                            <li className='flex flex-col items-center text-center gap-y-1 md:text-xl'>
                                ...
                                <h4 className='text-2xl font-bold'>We Take A Holistic Approach To Protection Planning.</h4>
                 ...
                 <section className='flex flex-col items-center w-full px-6 py-10 '>
                    <h1 className='mb-2 text-3xl font-bold text-center md:text-4xl '>Leveraging Trilogy Insurance Services</h1>
