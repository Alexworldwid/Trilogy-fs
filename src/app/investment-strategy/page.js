...
export const metadata = {
    title: 'Trilogy | Investment-Strategy',
        ...
        <>
          ...
          <main className='w-full' >
            <section id='hero3' className='flex flex-col justify-center p-4'>
                <h1 className='mt-3 mb-6 text-4xl font-bold text-center text-Black'>INVESTMENT STRATEGIES</h1>
                <div className='bg-[rgba(255,255,255,0.7)] p-4 flex flex-col items-center '
                >
                    <h2 className='mb-4 text-3xl font-semibold text-center'>Developing An Investment Strategy To Pursue Your Goals</h2>
            ...
            <section className='flex flex-col p-6 md:flex-row gap-x-4 md:justify-center'>
                <div className='mb-4 flex flex-col items-center max-w-[600px]'>
                    <h2 className='mb-4 text-4xl font-semibold'>Our Investment Strategies & Services:</h2>
                    ...
                    <ul className='grid grid-cols-2 gap-x-4 gap-y-2'>
                        <li className='flex items-center'><FaPlay className='mr-4 text-green-300' /> Investment Planning Strategies</li>
                        <li className='flex items-center'><FaPlay className='mr-4 text-green-300'  /> Investment Types</li>
                        <li className='flex items-center'><FaPlay className='mr-4 text-green-300' /> Investment Techniques</li>
                        <li className='flex items-center'><FaPlay className='mr-4 text-green-300'/> Knowing Your Risk Profile</li>
                    </ul>
                </div>
                <div className='bg-[#007d8a] md:w-[500px] px-6 py-10 text-white'>
                    <h2 className='mb-5 text-2xl font-bold'>We believe investing is about more than positive returns.</h2>
            ...
            <section className='bg-[#efefef] flex flex-col items-center py-10 px-6' >
                <h3 className='mb-4 text-3xl font-bold'>Every Investment Plan is Unique</h3>
            ...
            <section className='flex flex-col items-center p-6 gap-x-4 md:justify-center'>
                <h3 className='mb-4 text-4xl font-bold text-center'>Sound Investment Advice & Coaching</h3>
                ...
                <div className='flex flex-col '>
                    <h4 className='mb-4 text-2xl font-semibold text-center'>TYPES OF INVESTMENT VEHICLES:</h4>
                    <ul className='grid grid-cols-2 gap-4 mb-4'>
                        <li className='flex items-center'><FaPlay className='mr-4 text-green-300' />Alternatives</li>
                        <li className='flex items-center'><FaPlay className='mr-4 text-green-300' />Individual Stocks</li>
                        <li className='flex items-center'><FaPlay className='mr-4 text-green-300' />Separately Managed Accponts</li>
                        <li className='flex items-center'><FaPlay className='mr-4 text-green-300' />ETFs</li>
                        <li className='flex items-center'><FaPlay className='mr-4 text-green-300' />Mutual Funds</li>
                        <li className='flex items-center'><FaPlay className='mr-4 text-green-300' />UITs</li>
                        <li className='flex items-center'><FaPlay className='mr-4 text-green-300' />Fixed Annuities</li>
                        <li className='flex items-center'><FaPlay className='mr-4 text-green-300' />REITs</li>
                        <li className='flex items-center'><FaPlay className='mr-4 text-green-300' />Variable Annuities</li>
                        <li className='flex items-center'><FaPlay className='mr-4 text-green-300' />Individual Bonds</li>
                    </ul>
