    ...
    return (
        <main className='w-full relative'>
            ...
            <section id='hero-2' className='flex flex-col items-center justify-center  top-[2%] xl:left-[10%] opacity-80'>
                <h1 className='text-white text-4xl text-center md:text-6xl font-semibold'>FINANCIAL PLANNING FOR RETIREMENT</h1>
                <div className='mt-4 lg:mt-10 flex flex-col max-w-[1200px] items-center bg-[#eae9e9] p-8'>
                    <h2 className='text-black text-2xl text-center'>A Team of Retirement Planning Advisors Dedicated To You</h2>
                    <p className='my-4 text-[#2993a5] text-center'>We’re more than financial planners, we’re Life Planners</p>
                    <p className='text-center text-lg'>We believe planning for retirement is more than just savings – it’s about the life you aspire to live. Our Financial Advisors are here to help coach you through this important life stage.</p>
                </div>
            </section>

            <section className='p-4 flex flex-col md:flex-row gap-4 w-full mb-16'>
                <div className='w-full  px-4'>
                    ...
                    <ul className=' flex flex-col md:grid md:grid-cols-2'>
                        <li className='flex gap-3 items-center mb-2'><FaPlay className='text-[#78be20]' />Navigating 401(k) Rollover</li>
                        <li className='flex gap-3 items-center mb-2'><FaPlay className='text-[#78be20]' />Saving for Retirement</li>
                        <li className='flex gap-3 items-center mb-2'><FaPlay className='text-[#78be20]' />Investing for Retirement</li>
                        <li className='flex gap-3 items-center mb-2'><FaPlay className='text-[#78be20]' />Income Planning</li>
                        <li className='flex gap-3 items-center mb-2'><FaPlay className='text-[#78be20]' />Employer-Based Plans</li>
                        <li className='flex gap-3 items-center mb-2'><FaPlay className='text-[#78be20]' />Distribution Planning</li>
                        <li className='flex gap-3 items-center mb-2'><FaPlay className='text-[#78be20]' />Social Security Best Practices</li>
                        <li className='flex gap-3 items-center mb-2'><FaPlay className='text-[#78be20]' />Early Retirement Planning</li>
                        <li className='flex gap-3 items-center mb-2'><FaPlay className='text-[#78be20]' />Retirement Transitioning</li>
                    </ul>
                </div>

                <div className='w-full bg-[#007d8a] p-4'>
                    <h3 className='text-white text-xl font-bold mb-4'>At Trilogy, we empower you to live wealthy in retirement.</h3>
                    <p className='text-white mb-4'>We know that each decade of life brings new experiences, opportunities, concerns and financial focuses. This is why we believe you need more than a financial plan. You need a Life Plan.</p>
            ...
            <section className='bg-[#efefef] px-10 py-4 flex flex-col items-center'>
                ...
                <div className='grid grid-cols-2 gap-3 md:flex md:gap-8 md:mt-6 md:pb-6'>
                    <div className='flex flex-col items-center'>
                        ...
                        <p className='text-center font-semibold'>Start saving for retirement today</p>
                    </div>
                    <div className='flex flex-col items-center'>
                        <FaMoneyBillWave className='text-[#007d8a] text-6xl' />
                        <p className='text-center font-semibold'>Contribute to your 401(k) or IRA</p>
                    </div>
                    <div className='flex flex-col items-center'>
                        <FaRegChartBar className='text-[#007d8a] text-6xl' />
                        <p className='text-center font-semibold'>Maintain a retirement reserve</p>
                    </div>
                    <div className='flex flex-col items-center'>
                        <FaChartPie className='text-[#007d8a] text-6xl' />
                        <p className='text-center font-semibold'>Manage your portfolio risk</p>
                    </div>
                    <div className='flex flex-col items-center'>
                        <FaRegPauseCircle className='text-[#007d8a] text-6xl' />
                        <p className='text-center font-semibold'>Consider delaying Social Security</p>
                    </div>
                </div>
            </section>
            ...
            <section className='px-6 py-12 flex flex-col items-center bg-[#efefef] mb-6'>
                <h3 className=' text-3xl text-center mb-4 font-bold'>Common Types Of Retirement Plans</h3>
            ...
            <section className='px-6 py-12 flex flex-col md:items-center'>
                ...
                <p className='text-center mb-4 md:text-xl xl:max-w-[1200px] '>Whether you dream of traveling the world, wish to pursue a second career or want to retire early, we’re personally invested in helping you feel secure and prepared for life. We are dedicated to helping you build a road map that supports your personal goals, needs and desired lifestyle. However you define success, we are in it together. We will be your sounding board, your validation and your honest feedback.</p>
                 <h4 className='text-center font-semibold text-2xl mb-6'>COLLABORATE WITH YOUR FINANCIAL ADVISOR TO DISCUSS YOUR GOALS:</h4>
            ...
            <section className='bg-[#efefef] relative '>
                <div className='grandma flex flex-col justify-center '  >
                   <div className='bg-[rgba(255,255,255,0.8)] transition-all duration-500 ease-in-out p-6 md:w-[500px] xl:ml-[100px]'>
                       <h3 className='font-bold text-4xl mb-4'>Transitioning into Your New Life: Retirement</h3>
                       ...
                       <p className='md:text-xl mb-6 font-semibold'>Whether you want to transition gradually into retirement or dive in quickly, our Financial Advisor teams can support your goals with opportunities and advice that aims to help you live wealthy. We will show you all the options so you can make informed decisions.</p>
            ...
            <section className=' bg-[#efefef] py-10 px-6 flex flex-col items-center '>
                ...
                <p className='md:text-xl mb-6 text-center'>Together we will develop strategies to maximize your Social Security benefits that will empower you to live the retirement of your dreams.</p>
            ...
            <section className=' bg-[#efefef] py-10 px-6 flex flex-col items-center '>
                ...
                <ul className=' gap-6 grid grid-cols-2 md:grid-cols-4'>
                    <li className='flex flex-col items-center text-center font-semibold'><FaChartLine className='text-6xl text-[#007d8a] transition-all ease-in-out duration-500 hover:scale-110' />Optimizing your retirement income</li>
                    <li className='flex flex-col items-center text-center font-semibold'><FaListOl className='text-6xl text-[#007d8a] transition-all ease-in-out duration-500 hover:scale-110' />Developing a budget & savings plan</li>
                    <li className='flex flex-col items-center text-center font-semibold'><FaChartArea className='text-6xl text-[#007d8a] transition-all ease-in-out duration-500 hover:scale-110' />Minimizing taxes</li>
                    <li className='flex flex-col items-center text-center font-semibold'><FaChartPie className='text-6xl text-[#007d8a] transition-all ease-in-out duration-500 hover:scale-110' />Reducing risk & preserving wealth</li>
                    <li className='flex flex-col items-center text-center font-semibold'><BsBank className='text-6xl text-[#007d8a] transition-all ease-in-out duration-500 hover:scale-110' />Maximizing your Social Security benefits</li>
                    <li className='flex flex-col items-center text-center font-semibold'><FaMoneyBillWave className='text-6xl text-[#007d8a] transition-all ease-in-out duration-500 hover:scale-110' />Selecting a suitable investment approach</li>
                    <li className='flex flex-col items-center text-center font-semibold'><FaRegChartBar className='text-6xl text-[#007d8a] transition-all ease-in-out duration-500 hover:scale-110' />Determining your risk appetite</li>
                    <li className='flex flex-col items-center text-center font-semibold'><FaMoneyBillAlt className='text-6xl text-[#007d8a] transition-all ease-in-out duration-500 hover:scale-110' />Reducing & eliminating debt</li>
                </ul>
            </section>
