...
export const metadata = {
    title: 'Trilogy | College-Planning',
    description: 'Trilogy College Plans',
  };
    ...
    return (
        <>
            <main className='w-full'>
                <section id='hero4' className='flex flex-col items-center justify-center p-4'>
                    ...
                    <div className='bg-[rgba(255,255,255,0.8)] p-4 mt-5 max-w-[1200px]' >
                        <h2 className='mb-6 text-3xl font-semibold text-center md:text-4xl'>A Team Dedicated To Your Education Plans</h2>
                ...
                <section className='flex flex-col items-center justify-center gap-6 p-4 lg:flex-row'>
                    <div className='flex flex-col items-center max-w-[600px]'>
                        <h3 className='mb-4 text-3xl font-semibold text-center'>Our Education Planning Services:</h3>
                    ...
                    <div className='max-w-[500px] bg-[#007d8a] p-4 flex flex-col items-center'>
                        <h3 className='mb-4 text-2xl font-semibold text-center text-white'>At Trilogy, we empower you to financially prepare for a college experience.</h3>
                        <p className='mb-6 text-center text-slate-300'>We know higher education is a key building block for one`s future, and we know that many make sacrifices to see themselves and their loved ones achieve this goal. We also know that it is important to balance your feeling of financial confidence with the ability to pay for the education you or your family desires.</p>
                        <p className='mb-3 text-center text-slate-300'>Together, we will formulate the right education plan that fits into your unique Life Plan without jeopardizing your financial independence.</p>
                    </div>
                </section>
