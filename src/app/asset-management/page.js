            ...
            <main className='w-full flex flex-col items-center'>
                <section id='hero8' className='flex flex-col items-center justify-center  '>
                    ...
                    <div className='bg-[rgba(255,255,255,0.8)] p-7 flex flex-col items-center w-[90%]'>
                        <h2 className='text-center text-2xl font-medium mb-2'>WEALTH & ASSET MANAGEMENT SERVICES</h2>
                        ...
                        <p className='text-center font-medium'>Our Financial Advisors strive to help support, manage and grow your portfolio.</p>
                    </div>
                </section>

                <section className='grid md:grid-cols-2 gap-x-6 mt-6 p-3 py-10 max-w-[1200px]'>
                    <div>
                        <h3 className='text-4xl font-semibold mb-4'>Our Wealth & Asset Management Services:</h3>
                        ...
                        <ul className='grid md:grid-cols-2 gap-4'>
                            <li className='flex items-center gap-x-4 text-xl'><FaPlay className='text-[#78be20]' />Retirement Planning</li>
                            <li className='flex items-center gap-x-4 text-xl'><FaPlay className='text-[#78be20]' />Business Strategies</li>
                            <li className='flex items-center gap-x-4 text-xl'><FaPlay className='text-[#78be20]' />Investment Planning</li>
                            <li className='flex items-center gap-x-4 text-xl'><FaPlay className='text-[#78be20]' />Small Business Strategies</li>
                            <li className='flex items-center gap-x-4 text-xl'><FaPlay className='text-[#78be20]' />Gifting Strategies</li>
                            <li className='flex items-center gap-x-4 text-xl'><FaPlay className='text-[#78be20]' />Estate Planning Strategies</li>
                            <li className='flex items-center gap-x-4 text-xl'><FaPlay className='text-[#78be20]' />Insurance Services</li>
                            <li className='flex items-center gap-x-4 text-xl'><FaPlay className='text-[#78be20]' />College & Education Planning</li>
                            <li className='flex items-center gap-x-4 text-xl'><FaPlay className='text-[#78be20]' />Risk Management</li>
                            <li className='flex items-center gap-x-4 text-xl'><FaPlay className='text-[#78be20]' />Tax Strategies</li>
                        </ul>
                    </div>
                    <div className='mt-6 p-4 py-10 bg-[#007d8a]'>
                        <h4 className='text-3xl text-white mb-4 font-semibold'>At Trilogy, we help develop strategies for all of your wealth management needs.</h4>
                        <p className='text-slate-300 text-xl'>We help you create a personalized wealth & asset management strategy based on your lifestyle goals. Using our discovery process, we work with you to build an appropriate plan that supports your objectives, then monitor it to help you stay on track.</p>
                    </div>
                </section>
                ...
                <section className='flex flex-col items-center p-4 py-10 bg-[#efefef] w-full'>
                    <div className='flex flex-col items-center max-w-[1200px]'>
                        <h4 className='text-3xl text-center font-semibold mb-6 md:text-5xl'>Our Approach to Your Personalized Wealth Management Plan</h4>
                        <p className='text-center mb-4 md:text-xl font-medium'>We use a client-centric process focused on pursuing specific milestones we create together. Our comprehensive, three-step planning process is designed to help identify your needs, implement your strategy and monitor it to help you stay on course.</p>
                        <p className='text-center mb-4 md:text-xl font-medium'>In our approach, we will complete a confidential profile to gain a deeper understanding of your current situation and goals, provide custom strategies based on your analysis and future needs, and then help you put that plan into action.</p>
                        <p className='text-center mb-4 md:text-xl font-medium'>We are dedicated to your success and confidence in your personal finances. We will empower you to be nimble and will serve as the sounding board you need to make your decisions. We know how personal this is. And we’re committed to standing by your side through it all.</p>
                ...
                <section className='w-full flex flex-col items-center'>
                    <div className='max-w-[1200px] p-4 py-10'>
                        <h4 className='text-4xl text-center font-semibold mb-4'>How Your 401k & Retirement Plan Fits into Your Wealth & Asset Management Plan</h4>
                        ...
                        <h5 className='text-4xl text-center font-semibold mb-4'>OUR FINANCIAL PLANNING FOR RETIREMENT SERVICES:</h5>
                        <ul className='grid md:grid-cols-2 gap-4'>
                ...
                <section className='flex flex-col items-center p-4 py-10 bg-[#efefef] w-full'>
                    <div className='max-w-[1200px] p-4 py-10'>
                        <h4 className='text-4xl text-center font-semibold mb-10'>Common Types of Retirement Plans</h4>
                ...
                <section  className='flex flex-col items-center p-4 py-10 w-full'>
                    <div className='max-w-[1200px] p-4 py-10'>
                        <h4 className='text-4xl text-center font-semibold mb-10'>Begin Planning Your Retirement & Wealth Management Strategy Early</h4>
                ...
                <section className='flex flex-col items-center p-4 py-10 w-full bg-[#efefef]'>
                    <div className='max-w-[1200px] p-4 py-10 flex flex-col items-center'>
                        <h4 className='text-4xl text-center font-semibold mb-10'>How Your Estate Plan Strategy Fits into Your Wealth & Asset Management Plan</h4>
                ...
                <section className='flex flex-col items-center p-4 py-10 w-full'>
                    <div className='max-w-[1200px] p-4 py-10 flex flex-col items-center'>
                        <h4 className='text-4xl text-center font-semibold mb-10'>Our Estate & Generational Wealth Planning Services</h4>
                ...
                <section className='flex flex-col items-center p-4 py-10 w-full bg-[#efefef]'>
                    <div className='max-w-[1200px] p-4 py-10 flex flex-col items-center'>
                        <h4 className='text-4xl text-center font-semibold mb-10 md:text-5xl'>How Your Business Strategy Supports Your Personal Wealth & Asset Management Plan</h4>
                        ...
                        <h5 className='text-3xl text-center font-semibold mb-10 md:text-4xl'>PLANS WE CAN HELP YOU WITH:</h5>
                        <ul className='grid md:grid-cols-2 gap-4 md:gap-6'>
                ...
                <section className='flex flex-col items-center p-4 py-10 w-full'>
                    <div className='max-w-[1200px] p-4 py-10 flex flex-col items-center'>
                        <h4 className='text-4xl text-center font-semibold mb-10 md:text-5xl'>Our 401K & Qualified Plans Services</h4>
                        <ul className='grid md:grid-cols-2 gap-4 md:gap-6'>
                ...
                <section className='flex flex-col items-center p-4 py-10 w-full bg-[#efefef]'>
                    <div className='max-w-[1200px] p-4 py-10 flex flex-col items-center'>
                        <h4 className='text-4xl text-center font-semibold mb-10 md:text-5xl'>Qualified Planning for Employers and Employees</h4>
                ...
                <section className='flex flex-col items-center p-4 py-10 w-full '>
                    <div className='max-w-[1200px] p-4 py-10 flex flex-col items-center'>
                        <h4 className='text-4xl text-center font-semibold mb-10 md:text-5xl'>Employee Benefits and Executive Compensation</h4>
                        ...
                        <ul className='grid grid-cols-2 lg:grid-cols-5 gap-4 md:gap-6'>
                ...
                <section className='flex flex-col items-center p-4 py-10 w-full bg-[#efefef]'>
                    <div className='max-w-[1200px] p-4 py-10 flex flex-col'>
                        <h4 className='text-4xl text-center font-semibold mb-10 md:text-5xl'>How Your Insurance Strategy Supports Your Personal Wealth & Asset Management Plan</h4>
                        ...
                        <h5 className='text-4xl text-center font-semibold mb-10 md:text-5xl'>OUR INSURANCE SERVICES:</h5>
                        <ul className='grid md:grid-cols-2 gap-4 md:gap-6'>
                ...
                <section className='flex flex-col items-center p-4 py-10 w-full '>
                    <div className='max-w-[1200px] p-4 py-10 flex flex-col'>
                        <h4 className='text-4xl text-center font-semibold mb-10 md:text-5xl'>How Your Investment Plan Supports Your Personal Wealth & Asset Management Plan</h4>
                        ...
                        <h5 className='text-3xl text-center font-semibold mb-10 md:text-4xl'>OUR INVESTMENT STRATEGIES & SERVICES</h5>
                        <ul className='grid md:grid-cols-2 gap-4 md:gap-6'>
                ...
                <section className='flex flex-col items-center p-4 py-10 w-full bg-[#efefef]'>
                    <div className='max-w-[1200px] p-4 py-10 flex flex-col '>
                        <h4 className='text-4xl text-center font-semibold mb-10 md:text-5xl'>Common Types of Investments</h4>
                        <ul className='grid md:grid-cols-2 gap-4 md:gap-6'>
                ...
                <section className='flex flex-col items-center p-4 py-10 w-full '>
                    <div className='max-w-[1200px] p-4 py-10 flex flex-col items-center'>
                        <h4 className='text-4xl text-center font-semibold mb-10 md:text-5xl'>How Risk Management Impacts Your Personal Wealth & Asset Management Plan</h4>
