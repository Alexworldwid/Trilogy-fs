...
const Form = ({ handleCloseForm, openForm }) => {
    ...
    return (
        <div id='form-container' className={`${openForm ? 'opacity-100' : 'opacity-0'} transition-all duration-1000 ease-in-out fixed top-[15%] left-0 w-full h-auto md:w-[500px] md:left-[15%] lg:left-[25%] xl:left-[35%]  my-auto bg-white z-50 flex flex-col items-center`}>
